...
"""
ibl-app documentation build configuration file.
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'IBL test app',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'ibl_app'),
                os.path.join(root_path, 'ibl_app/migrations')])
